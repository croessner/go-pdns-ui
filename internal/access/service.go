...
func (s *NoopService) FilterZones(_ context.Context, _ auth.User, zones []domain.Zone) ([]domain.Zone, error) {
...
func (s *NoopService) CanAccessZone(_ context.Context, _ auth.User, _ string) (bool, error) {
	return true, nil
}
